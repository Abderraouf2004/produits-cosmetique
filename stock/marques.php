...
<body style=" margin-top:10% ;">
   <div class="container py-2" >
    ...
    <a href="../admine/ajouter marque.php" class="btn btn-primary">ajouter</a>
...
if($res){
   while ($row = mysqli_fetch_row($res)){
    ...
    <td>
    <img width=100px class="img img-fluid" src="../images/marque/<?php echo $row[2] ?>">
    </td>
    <td>
      <a href="../admine/modifier_marque.php?id=<?php echo $row[0] ?>" class="btn btn-primary">modifier</a>
      <a href="../admine/supprimer_marque.php?id=<?php echo $row[0] ?>" onclick="return confirm('voulez vous vraiment supprimer la marque <?php echo $row[1]?>');" class="btn btn-danger">supprimer</a>  
    </td></tr> <?php
