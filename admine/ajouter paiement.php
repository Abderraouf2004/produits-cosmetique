<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($libelle) && !empty($name)){
            $query="INSERT INTO mode_de_paiement(nom,image)VALUES('$libelle','$name');"; 
...
<div class="container py-2">
      <form method="POST" enctype="multipart/form-data">
          ...
          <button type="submit"  name="submit" >ajoute mode de paiement</button>
      </form>
    </div>
