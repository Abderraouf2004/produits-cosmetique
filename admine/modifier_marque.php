<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($libelle)){
            if(!empty($name)){
             $query3="UPDATE marque SET nom='$libelle',image='$name' WHERE id='$id'"; 
            }else{
             $query3="UPDATE marque SET nom='$libelle' WHERE id='$id'"; 
            }
    ...
    $query2="SELECT * FROM marque WHERE id='$id'";
...
<div class="container py-2">
      <form method="POST" enctype="multipart/form-data">
            ...
            <img width="25px" class="img img-fluid" src="../images/marque/<?php echo $row2[2] ?>" ><br>
          <button type="submit"  name="submit" >modifier marque</button>
      </form>
    </div>
